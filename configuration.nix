  ...
  home-manager.users.katexochen = {pkgs, ...}: {
    ...
    wayland.windowManager.sway = {
      ...
      config = {
        ...
        keybindings = let
          mod = config.home-manager.users.katexochen.wayland.windowManager.sway.config.modifier;
          inherit
            (config.home-manager.users.katexochen.wayland.windowManager.sway.config)
            left
            down
            up
            right
